...
public class Railway2 {
    private static final String train_name = "Thanjavur - Kumbakkonam Passenger";
    private static final String train_num = "56820";
    private static final String train_stops[] = { "Thanjavur", "Ayyampet", "Papanasam", "Swamimalai", "Darasuram",
            "Kumbakkonam" };
    ...
    private static void book_home() {
        System.out.println("\t\t\t\t--------------Welcome to IRCTC Training Booking Application----------");
    ...
    private static void admin() {
        ...
        if (admin_id == 101 && admin_pass == 1234) {
            ...
            System.out.println("Booking Details for Thanjavur - Kumbakkonam Passenger");
            System.out.println();
    ...
    private static void user_signup() {
        ...
        System.out.println("Remember for login credentials!!!");
        user_id++;
    ...
    private static void orgUser() {
        ...
        System.out.println("2.Booking Details and  Cancel Ticket");
        System.out.println("3.View Train Details");
        System.out.println("4.IRCTC Wallet");
    ...
    private static void confirm_seat(int no, int stop, int arr) {
        ...
        lb1: for (int j = 0; j < 3; j++) {
            ...
            if (sum == 0) {
                ...
                System.out.println(
                        " Seat Allocated for the User " + user_list.get(index).u_name + " Your Seat Number is " + j +
                                " Your Ticket Number is:" + tic_no);

                System.out.println("Amount for this ticket is " + curr_amt + " Deducted from IRCTC Wallet");
                flag = false;
    ...
    private static void wallet() {
        System.out.println("Your IRCTC Wallet is " + user_list.get(index).u_amt);
        System.out.println("\t\t\tPress enter to continue...");
        scan.nextLine();
        String s = scan.nextLine();
        System.out.print("\033[H\033[2J");
    ...
    private static void cancel_ticket() {
        ...
        System.out.println("Press 1 to cancel Ticket or press any key to go back..... ");
        String s = scan.next();
        if (s.equals("1")) {
    ...
    private static void userList() {
        user_list.add(new users("abcd", "1234", "9915457854", 10000, 93));
        user_list.add(new users("efgh", "5678", "7615661555", 9000, 92));
        user_list.add(new users("ijkl", "2468", "8785437353", 3000, 90));
    }

}

class users extends Railway2 {
...
class waiters extends Railway2 {
